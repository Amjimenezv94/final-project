        ...
        return (
            ...
            <div className="container">
                <ul class="nav nav-pills  mb-3 p-2 justify-content-center" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" >
                        <a class="nav-link px-5 text-light" id="pills-presencial-tab" data-toggle="pill" href="#pills-presencial" role="tab" aria-controls="pills-presencial" aria-selected="false" id="Home"> <h3>PRESENCIAL</h3></a>
                    </li>
                   
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-virtal" role="tabpanel" aria-labelledby="pills-virtal-tab"><TabVirtual/></div>

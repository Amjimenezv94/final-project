            ...
            <div className="container-fluid py-5 d-flex justify-content-center mx-3"> 
                ...
                <div className="row ">
                    <div className="contenerdor-result-uno col-md-12 mt-5 text-center text-light">
                        ...
                        <br/>
                        <p id="Resultado" className="parrafo-resultado text-center justify-content-center"> <strong>{local}</strong> Parece que tienes habilidades marcadas en esta/s rama/s del conocimiento, te invitamos a explorar sus opciones en la siguiente card </p>       
